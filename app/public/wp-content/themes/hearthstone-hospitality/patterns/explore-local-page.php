...
<div class="wp-block-column"><!-- wp:group {"className":"hearthstone-card","layout":{"type":"constrained"}} -->
<div class="wp-block-group hearthstone-card"><!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">At the property</h3>
<!-- /wp:heading -->
...
<!-- wp:image {"sizeSlug":"large","linkDestination":"none","className":"hearthstone-photo-frame"} -->
<figure class="wp-block-image size-large hearthstone-photo-frame"><img src="/wp-content/themes/hearthstone-hospitality/assets/images/nearby.png" alt="Map and nearby points around Hearthstone Hospitality"/></figure>
<!-- /wp:image -->
