...
<p class="has-text-color" style="color:#6f8680;font-size:13px;letter-spacing:0.12em;text-transform:uppercase">Dining</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":1,"style":{"color":{"text":"#4e4035"}}} -->
<h1 class="wp-block-heading has-text-color" style="color:#4e4035">Dining that complements the stay</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"color":{"text":"#393633"}}} -->
<p class="has-text-color" style="color:#393633">Use this page for current offerings first, then note future additions clearly as upcoming.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h2 class="wp-block-heading">Current dining details</h2>
<!-- /wp:heading -->

<!-- wp:list -->
<ul><li>Service hours</li><li>Menu highlights</li><li>Seasonal closures or changes</li></ul>
<!-- /wp:list -->
...
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Upcoming additions</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Use this section for future dining expansion, bar updates, or market offerings. Keep timelines realistic.</p>
<!-- /wp:paragraph -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"style":{"color":{"background":"#9a6a45","text":"#f7f4ee"},"border":{"radius":"999px"}}} -->
<div class="wp-block-button"><a class="wp-block-button__link has-text-color has-background wp-element-button" style="border-radius:999px;color:#f7f4ee;background-color:#9a6a45">View dining details</a></div>
<!-- /wp:button -->

<!-- wp:button {"className":"is-style-outline","style":{"border":{"radius":"999px"}}} -->
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" style="border-radius:999px">Contact dining team</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
HTML;
